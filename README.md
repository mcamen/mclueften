...
- **CO₂-Schätzung** (Luftqualität): eigenes Diagramm mit Schwellenlinien, Status-Ampel und – bei stickiger Luft – ein „kurz stoßlüften"-Hinweis (unabhängig von der Hitze-Empfehlung). Skaliert mit der Personenzahl; optional auf einen gemessenen Sensorwert kalibrierbar.
